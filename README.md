...
Compilation:
Save all Java files in the appropriate directory structure matching the package declarations.
Open a command prompt or terminal.
Navigate to the root directory containing the Main.java file.
